...
This chapter describes the syntax and informal semantics of Intentio items. An \emph{item}\index{item} is a component of a module. Items are uniquely named within the module and are organized in the flat structure.
