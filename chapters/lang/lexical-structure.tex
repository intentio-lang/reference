...
The keyword \lstinline{none} evaluates to none term, which is a special value \emph{none} of type \lstinline{None}. It is used to make boolean result as succ none or fail none.